...
const Contact = () => {
  ...
  return (
    <div className="max-w-container mx-auto px-4">
      ...
      <div className="pb-10">
        <h1 className="text-primeColor font-semibold text-lg mb-2">Contact Skinncube @</h1>
        <p className="max-w-[600px] text-base text-lightText mb-4">
          Phone: +91 81090 92892
          {"\n"}
          Office Address: 58/H Kalani nagar airport road, Indore, 452005
          {"\n"}
          Mail: Skinncube@gmail.com
          Owner: Aditya Gupta
        </p>
      </div>
      {successMsg ? (
